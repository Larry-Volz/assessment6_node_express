...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2021-11-08T02:10:06.975065" />
  ...
  <link href="/media/css/fontawesome.css?3a286435" rel="stylesheet">
  <link rel="stylesheet" href="/media/css/bootstrap-4.4.1.min.css">
  <link rel="shortcut icon" href="/favicon.ico" />
  
    <link rel="stylesheet" type="text/css" href="/dyncss/base.css?3a286435">
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/dynamodb-fdw-100-released-2344/">DynamoDB fdw 1.0.0 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-11-02 by Toshiba</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/odb-250-b21-adds-support-for-bulk-operations-in-postgresql-14-2339/">ODB 2.5.0-b.21 adds support for bulk operations in PostgreSQL 14</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-11-02 by Code Synthesis</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/postgresql-weekly-news-october-31-2021-2342/">PostgreSQL Weekly News - October 31, 2021</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-11-01 by PWN</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/postgresql-jdbc-4231-released-2343/">PostgreSQL JDBC 42.3.1 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-11-01 by JDBC Project</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/babelfish-for-postgresql-2340/">Babelfish for PostgreSQL</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-11-01 by Amazon Web Services</li>
              </ul>
            </li>
...
<!-- Blog -->
 <div class="container margin">
   ...
   <div class="row">
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5cs"> Fun with SQL in Postgres: Finding Revenue Accrued Per Day</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Jonathan Katz</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-11-05</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5cq"> pg_upgrade and OpenBSD</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5cp"> Can&#39;t Resize your Postgres Kubernetes Volume? No Problem!</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Jonathan Katz</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-11-04</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5cn"> Cloud: IO limits gone full circle</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5cm"> Three Cases Against IF NOT EXISTS / IF EXISTS in Postgres DDL</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5cl"> Patroni &amp; etcd in High Availability Environments</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Caitlin Strong</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-11-03</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5ck"> Open-source🍃MongoDB API to 🚀YugabyteDB with 🥭MangoDB proxy</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Franck Pachot</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-11-03</li>
            </ul>
 ...
 <!-- END SUBMIT A BUG -->
    ...
    <script src="/media/js/main.js?3a286435"></script>
